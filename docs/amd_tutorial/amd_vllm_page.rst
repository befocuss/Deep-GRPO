...
Then, you can choose to enable CUDA graph by setting the following environment variables (see `this page <https://github.com/anonymous/anonymous-repo/blob/v0.3.0.rc0/docs/README_vllm0.8.md>`_):
