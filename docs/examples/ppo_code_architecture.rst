...
`main_ppo.py <https://github.com/anonymous/anonymous-repo/blob/main/verl/trainer/main_ppo.py>`_.
In this tutorial, we will go through the code architecture in `main_ppo.py <https://github.com/anonymous/anonymous-repo/blob/main/verl/trainer/main_ppo.py>`_.
...
files in `data_preprocess directory <https://github.com/anonymous/anonymous-repo/blob/main/examples/data_preprocess>`_. Currently, we support
...
For example, we already provide reward functions for `GSM8k <https://github.com/anonymous/anonymous-repo/blob/main/verl/utils/reward_score/gsm8k.py>`_ 
and `MATH <https://github.com/anonymous/anonymous-repo/blob/main/verl/utils/reward_score/math.py>`_
...
See `reward functions <https://github.com/anonymous/anonymous-repo/blob/main/verl/utils/reward_score>`_ for detailed implementation.
...
pre-defined several roles in `ray_trainer.py <https://github.com/anonymous/anonymous-repo/blob/main/verl/trainer/ppo/ray_trainer.py#L38>`_.
...
- We also pre-implemented workers for ``Actor``, ``Rollout``,
  ...
  and Megatron-LM.
  See `FSDP Workers <https://github.com/anonymous/anonymous-repo/blob/main/verl/workers/fsdp_workers.py>`_ 
  and `Megatron-LM Workers <https://github.com/anonymous/anonymous-repo/blob/main/verl/workers/megatron_workers.py>`_
...
- If it's a model-based RM, directly add the ``RewardModel`` role in the
  ...
  - Note that the pre-defined ``RewardModelWorker`` only supports models
    ...
    need to define your own RewardModelWorker in `FSDP Workers <https://github.com/anonymous/anonymous-repo/blob/main/verl/workers/fsdp_workers.py>`_ 
    and `Megatron-LM Workers <https://github.com/anonymous/anonymous-repo/blob/main/verl/workers/megatron_workers.py>`_.
...
See reward functions implemented in `directory <https://github.com/anonymous/anonymous-repo/blob/main/verl/utils/reward_score/>`_ 
for more information.
