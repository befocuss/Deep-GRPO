...
We already pre-implemented some reward functions in `reward_score directory <https://github.com/anonymous/anonymous-repo/blob/main/verl/utils/reward_score>`_.
...
In the entrypoint of the PPO Post-Training script `main_ppo.py <https://github.com/anonymous/anonymous-repo/blob/main/verl/trainer/main_ppo.py#L33>`_,
...
- In the `GSM8k example <https://github.com/anonymous/anonymous-repo/blob/main/verl/utils/reward_score/gsm8k.py>`_, we
...
- In the `MATH example <https://github.com/anonymous/anonymous-repo/blob/main/verl/utils/reward_score/math.py>`_, we follow
