...
`megatron_vllm.py <https://github.com/anonymous/anonymous-repo/blob/main/verl/workers/sharding_manager/megatron_vllm.py>`_
and `megatron_sglang.py <https://github.com/anonymous/anonymous-repo/blob/main/verl/workers/sharding_manager/megatron_sglang.py>`_.
...
(i.e., transfer protocols) can be found in `decorator.py <https://github.com/anonymous/anonymous-repo/blob/main/verl/single_controller/base/decorator.py>`_.
...
See `source code <https://github.com/anonymous/anonymous-repo/blob/main/verl/workers/megatron_workers.py#L63>`_ for more information.
...
kinds of models, please refer to `MCore Document <https://github.com/anonymous/anonymous-repo/blob/main/verl/models/mcore/readme.md>`_.
