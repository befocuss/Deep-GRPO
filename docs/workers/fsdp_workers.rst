...
vLLM in `fsdp_vllm.py <https://github.com/anonymous/anonymous-repo/blob/main/verl/workers/sharding_manager/fsdp_vllm.py>`_.
...
See `source code <https://github.com/anonymous/anonymous-repo/blob/main/verl/workers/fsdp_workers.py>`_. for more information.
