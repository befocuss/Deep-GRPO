...
df = pd.read_csv("../../data/tree_methods_training_instability/test_reward.csv")

df = df[["Step", 
        "Qwen2.5-0.5B-Instruct-TreeRL - val-core/openai/gsm8k/acc/mean@1"]]

df = df.rename(columns={
    "Qwen2.5-0.5B-Instruct-TreeRL - val-core/openai/gsm8k/acc/mean@1": "TreeRL"
})
...
plt.savefig("../../figures/training_instability/treerl_accuracy.pdf", dpi=300)