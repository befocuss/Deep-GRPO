...
MODEL=/root/data/hf-models/Qwen2.5-3B
DATA_DIR=/root/data/hf-datasets
OUTPUT_DIR=/root/data
RUN_NAME=Qwen2.5-3B-HotpotQA-GRPO-01211612
...
export retriever_url=http://placeholder-retriever:8000/retrieve

python3 -m verl.trainer.main_ppo \
    algorithm.adv_estimator=grpo \
    data.train_files="[$DATA_DIR/hotpotqa/train.parquet]" \
    data.val_files="[$DATA_DIR/hotpotqa/test.parquet]" \
    ...
    actor_rollout_ref.rollout.spo.expand_branch_chain=False \
    actor_rollout_ref.rollout.spo.branches_per_point=8 \
    actor_rollout_ref.rollout.spo.n_branch_points=1 \
    actor_rollout_ref.rollout.spo.low_quality_trajectory_reward_threshold=0.2 \
