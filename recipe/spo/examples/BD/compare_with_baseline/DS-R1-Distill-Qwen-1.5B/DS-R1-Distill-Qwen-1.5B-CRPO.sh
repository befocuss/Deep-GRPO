...
MODEL=/root/data/hf-models/DS-R1-Distill-Qwen-1.5B
DATA_DIR=/root/data/hf-datasets
OUTPUT_DIR=/root/data
RUN_NAME=DS-R1-Distill-Qwen-1.5B-CRPO-tp-s200-lam1-gamma2-p1b8-01252211
...
python3 -m  verl.trainer.main_ppo \
    ...
    data.train_files="[$DATA_DIR/deepscaler/train.parquet]" \
    ...
    actor_rollout_ref.rollout.spo.tokens_per_node=400 \
