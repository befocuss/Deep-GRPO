...
MODEL=/root/data/hf-models/Qwen2.5-Math-1.5B
DATA_DIR=/root/data/hf-datasets
OUTPUT_DIR=/root/data
RUN_NAME=Qwen2.5-Math-1.5B-MATH-CRPO-tp-s100-gamma2-p1b8-01202224
...
python3 -m  verl.trainer.main_ppo \
    ...
    data.val_files="[$DATA_DIR/math/test.parquet,$DATA_DIR/aime24/test.parquet,$DATA_DIR/minerva/test.parquet,$DATA_DIR/amc/test.parquet,$DATA_DIR/olympiad_bench/test.parquet]" \
    ...
    actor_rollout_ref.rollout.spo.segment_method=tp \
    actor_rollout_ref.rollout.spo.n_branch_points=1 \
    actor_rollout_ref.rollout.spo.tokens_per_node=100 \
    ...
    actor_rollout_ref.rollout.spo.utility_sampling.position_bias=2 \
    ...
    trainer.total_epochs=20 | tee $OUTPUT_DIR/logs/$RUN_NAME.log 