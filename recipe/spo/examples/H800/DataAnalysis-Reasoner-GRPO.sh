...
/workspace/miniconda3/bin/conda run -p /workspace/miniconda3/envs/verl --no-capture-output python3 -m  verl.trainer.main_ppo \
    ...
    data.train_files="[$DATA_DIR/wikitq/train.parquet,$DATA_DIR/multihiertt/train.parquet,$DATA_DIR/ottqa/train.parquet,$DATA_DIR/hybridqa/train.parquet,$DATA_DIR/finqa/train.parquet]" \
    data.val_files="[$DATA_DIR/wikitq/test.parquet,$DATA_DIR/multihiertt/test.parquet,$DATA_DIR/ottqa/test.parquet,$DATA_DIR/hybridqa/test.parquet,$DATA_DIR/finqa/test.parquet]" \
