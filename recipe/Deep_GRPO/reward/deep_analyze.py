...
from recipe.Deep_GRPO.prompts.data_analysis import REPORT_SOUNDNESS_EVALUATE_PROMPT, REPORT_QUALITY_EVALUATE_PROMPT, ANSWER_CORRECTNESS_EVALUATE_PROMPT, RESPONSE_QUALITY_PROMPT
